...
LOG = "bot_semanal_v2.log"
EXCEL_HIST = "Historial_Operaciones_Semanal_V2.xlsx"
ESTADO_BOT = "estado_bot_semanal_v2.json"
...
def main():
    ...
    log(f"🤖 BOT V2 (SEMANAL) arrancado (loop={args.loop}, intervalo={args.intervalo} min, "
